    ...
    <div class="content">
        ...
        <div class="page-header">
            <div class="lang-buttons">
                <a class="lang_but1 <?php if ($lang['LANG'] == 'pl') echo "active"; ?>" href="kontakt.php?lang=pl"></a>
                <a class="lang_but2 <?php if ($lang['LANG'] == 'en') echo "active"; ?>" href="kontakt.php?lang=en"></a>
                <a class="lang_but3 <?php if ($lang['LANG'] == 'de') echo "active"; ?>" href="kontakt.php?lang=de"></a>
            </div>
        </div>
        <div class="text-area">
            <div class="kostka kontakt"> </div>
            <div class="tlo">
            </div>
            <div class="mini-menu">
                ...
                <a class="mini-menu-kontakt active"></a>
                <a class="mini-menu-galeria" href="galeria.php?lang=<?php echo $lang['LANG'];?>"></a>
            </div>
            <div class="text-field">
                <div class="menu-title"> <?php echo $lang['MENU_KONTAKT'];?></div>
            </div>
        </div>
